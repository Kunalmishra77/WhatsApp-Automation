  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <LineChart data={data} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
        ...
        <Tooltip formatter={(v: number, name: string) => name === 'mrr' ? [`₹${v.toLocaleString('en-IN')}`, 'MRR'] : [v, 'Clients']}
        ...
        <Line type="monotone" dataKey="clients" stroke="#2563EB" strokeWidth={2} dot={false} name="Clients" yAxisId={1} hide />
      </LineChart>
    </ResponsiveContainer>
  );
}
