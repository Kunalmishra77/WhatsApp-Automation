...
export interface QuestionNodeData { label: string; message: string; timeoutHours: number; }
export interface ConditionNodeData{ label: string; keyword: string; matchType: 'contains' | 'equals' | 'starts_with'; }
