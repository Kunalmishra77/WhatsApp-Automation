...
export function AIRevenueDashboard() {
  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto bg-surface-secondary">
      <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 py-6 sm:py-8 space-y-6 sm:space-y-8">
        ...
        {!loading && hotLeads.length > 0 && (
          <div className="rounded-2xl border border-border bg-card overflow-hidden">
            <div className="border-b border-border px-4 sm:px-6 py-3 sm:py-4 flex items-center gap-2 flex-wrap">
            ...
            <div className="divide-y divide-border">
              {hotLeads.map((item) => {
                ...
                return (
                  <div key={contact?.id} className="flex items-start gap-3 sm:gap-4 px-4 sm:px-6 py-3 sm:py-4 hover:bg-muted/30 transition-colors">
