...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 backdrop-blur-[2px] bg-black/50",
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "shadow-[0_25px_50px_-12px_rgb(0_0_0/0.25),0_8px_24px_-8px_rgb(0_0_0/0.15)]",
        "p-6",
        // Animation
        "duration-200",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          "absolute right-4 top-4 rounded-lg p-1 transition-all",
